...
public class CartItemTest {
    ...
    void testGetterAndSetter() {
        User user = new User("Nhi", "098", "len@gmail.com", "527 dbp", "nhan vien", "Female", "active", "url");
        ...
        User user1 = new User("Nhi", "098", "len@gmail.com", "527 dbp", "nhan vien", "Female", "active", "url");
